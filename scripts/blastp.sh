...
blastp -task blastp -db $BLASTTMPDIR/$(basename $BLASTDB) -query $CHUNKSDIR/chunk.${SLURM_ARRAY_TASK_ID} -evalue 1e-4 -outfmt 6 | gzip > $CHUNKSDIR/chunk.${SLURM_ARRAY_TASK_ID}.blast.gz
